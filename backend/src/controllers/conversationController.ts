...
export const getConversations = asyncHandler(async (req: Request, res: Response) => {
  ...
  const formattedConversations = conversations.map(convo => {
    ...
    return {
      ...
      isArchived: convo.archivedBy?.includes(userId) || false
    };
  });
...
export const getConversationById = asyncHandler(async (req: Request, res: Response) => {
  ...
  const formattedConversation = {
    ...
    isArchived: conversation.archivedBy?.includes(userId) || false,
    messages
  };
...
export const createOrGetConversation = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (existingConversation) {
    ...
    if (existingConversation.deletedFor?.includes(otherUserId)) {
    ...
    const response = {
      ...
      isArchived: existingConversation.archivedBy?.includes(userId) || false,
      isExisting: true
    };

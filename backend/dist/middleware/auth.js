...
// Protect routes - authenticate user token
exports.protect = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.headers.authorization &&
        ...
        try {
            ...
            // Verify token
            const decoded = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET || 'jwtsecret123');
...
const authorize = (...roles) => {
    return (req, res, next) => {
        ...
        if (!roles.includes(req.user.role)) {
            res.status(403);
            throw new Error(`Not authorized. Role ${req.user.role} cannot access this resource`);
        }
        next();
    };
};

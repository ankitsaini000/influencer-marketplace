              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-100">
                    ...
                    ].map(({ platform, color, path }) => (
                      <a
                        key={platform}
                        href="#"
                        onClick={(e) => e.stopPropagation()}
                        className={`p-2 rounded-lg hover:bg-gray-50/80 text-gray-400 hover:${color} transition-all duration-300`}
                      >
                        <svg
                          className="w-4 h-4"
                          fill="currentColor"
                ...
                <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-100">
                  ...
                  >
                    ...
                    <svg
                      className={`w-7 h-7 ${
                        creator.isLiked ? "text-red-500" : "text-gray-400"
                      } hover:text-red-500 transition-colors relative`}
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 7.84 6.84 11.02c4.18-4.18 8.36-6.6 11.48-9.02 3.12 2.42 5.2 7.84 10.62 12.02 15.04 4.92z" />
                    </svg>
                  </button>
                </div>
              </div>

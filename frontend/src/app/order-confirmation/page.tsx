...
import { getOrderWithCreatorDetails } from '@/services/api';
  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      try {
        ...
        if (orderId !== 'unknown') {
          ...
          if (response.success && response.data) {
            ...
            const formattedOrder: OrderData = {
              ...
              creatorUsername: data.creatorUsername || data.creatorId,
              creatorImage: data.creatorImage || 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80',
              ...
              packagePrice: data.packagePrice || '₹999',
              packageDetails: data.packageDetails || 'Package details',
              packageDeliveryDays: data.packageDeliveryDays || 7,
              packageRevisions: data.packageRevisions || 1,
              platformFee: data.platformFee || '₹50',
              totalAmount: data.totalAmount || '₹1049',
            ...
            console.log('Order data with creator details fetched successfully:', formattedOrder);
        ...
        // Fallback to mock data if API call fails or orderId is 'unknown'
